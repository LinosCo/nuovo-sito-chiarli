...
export const BlogSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="blog" className="py-24 md:py-32 bg-chiarli-wine relative overflow-hidden">
      <div
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-2xl mb-16">
          <span className={`font-sans text-[10px] font-bold uppercase tracking-widest text-white/60 mb-4 block transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            Storie e Tradizione
          </span>
          <h2 className={`font-serif text-4xl md:text-6xl lg:text-7xl text-white leading-[1.1] mb-6 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Il nostro <span className="italic text-white">Blog</span>
          </h2>
          <p className={`text-white/80 text-base md:text-lg leading-relaxed transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
