        ...
        {[...Array(40)].map((_, i) => (
          <div
            ...
            style={{
              ...
              left: `${2 + (i * 2.5) % 96}%`,
              bottom: `-${10 + (i % 3) * 5}%`,
              background: `radial-gradient(circle at 30% 30%, rgba(87,15,26,${0.3 + (i % 4) * 0.1}), rgba(87,15,26,${0.15 + (i % 3) * 0.05}))`,
              boxShadow: `inset 0 0 ${2 + i % 3}px rgba(255,255,255,0.2)`,
              animation: `bubble-rise ${8 + (i % 6) * 2}s ease-in-out infinite`,
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div className="max-w-xl">
             <span
               className={`font-sans text-[10px] font-bold uppercase tracking-widest text-chiarli-wine mb-4 block transition-all duration-700 ${
