...
export const WineDetailPage: React.FC<WineDetailPageProps> = ({
  ...
  useEffect(() => {
    const loadWineData = async () => {
      try {
        ...
        const timestamp =
          new URL(window.location.href).searchParams.get("t") || Date.now();
          ...
          let related = data.wines
            .filter(
              (w: WineData) =>
                w.isActive &&
                w.slug !== slug &&
                (w.family === wine.family ||
                  w.denomination === wine.denomination),
            )
            .slice(0, 3);
  ...
  const defaultWine: WineData = {
    ...
    tastingNotes: {
      aspetto:
        "Colore chiaro e vivace, con riflessi rosati. Spuma fine ed evanescente.",
      profumo:
        "Bouquet floreale con note di viola e rosa canina. Sentori di lievito e crosta di pane.",
      gusto:
        "Secco e sapido, freschezza vibrante. Finale lungo e persistente, di grande eleganza.",
    },
    isActive: true,
    order: 0,
  };
  ...
  const tastingNotes = wine.experienceSections
    ? [
        {
          title: "Degusta",
          description: wine.experienceSections.degusta || "Non disponibile",
        },
        {
          title: "Abbina",
          description: wine.experienceSections.abbina || "Non disponibile",
        },
        {
          title: "Scopri",
          description: wine.experienceSections.scopri || "Non disponibile",
        },
      ]
    : [
        {
          title: "Visiva",
          description: wine.tastingNotes.aspetto || "Non disponibile",
        },
        {
          title: "Olfatto",
          description: wine.tastingNotes.profumo || "Non disponibile",
        },
        {
          title: "Palato",
          description: wine.tastingNotes.gusto || "Non disponibile",
        },
      ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-x-hidden bg-gradient-to-br from-chiarli-text via-[#2a1f23] to-chiarli-text">
        ...
        >
          ...
          />
          <span className="font-sans text-xs font-bold uppercase tracking-widest hidden sm:inline">
            Torna ai vini
          </span>
        </button>
          ...
          <div className="w-full lg:w-1/2 flex items-center px-6 md:px-16 lg:px-20 py-8 lg:py-32">
            <div className="max-w-xl mx-auto lg:mx-0">
              ...
              >
                ...
                {/* Analisi */}
                {wine.technicalSpecs?.find(
                  (s) => s.label === "Caratteristiche",
                ) && (
                  <div className="flex items-baseline gap-3 group">
                    <span className="font-sans text-[10px] font-bold uppercase tracking-widest text-chiarli-wine-light/60 min-w-[100px]">
                      Analisi
                ...
                <div className="flex items-center gap-6 pt-2">
                  {wine.alcohol && (
                    <div className="flex items-center gap-2 group">
                      <Wine
                        size={14}
                        className="text-chiarli-wine-light/60 group-hover:text-chiarli-wine-light transition-colors"
                      />
                      <span className="font-sans text-xs text-white/70 group-hover:text-white transition-colors">
        ...
        >
          ...
          <ChevronDown
            size={20}
            className="text-chiarli-wine-light animate-bounce"
          />
        </div>
      </section>
        ...
        <div className="relative z-10 min-h-screen flex items-center py-16 md:py-24 lg:py-32">
          <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-12 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div>
                <span
                  className="font-sans text-[10px] font-bold uppercase tracking-widest text-white mb-4 block"
                  style={{
                    textShadow:
                ...
                <h2
                  className="font-serif text-3xl md:text-5xl lg:text-6xl text-white mb-6 md:mb-8 leading-tight"
                  style={{
                    textShadow:
                      "0 2px 25px rgba(0,0,0,0.9), 0 0 50px rgba(0,0,0,0.6)",
                  }}
                >
                  Un viaggio
                  ...
                  {tastingNotes.map((note, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3 md:gap-4">
                        <span
                          className={`font-serif text-2xl md:text-4xl transition-all duration-300 ${
                            activeTab === index
                        ...
                        <span
                          className={`font-sans text-xs md:text-sm font-bold uppercase tracking-widest transition-colors ${
                            activeTab === index
                              ? "text-chiarli-wine"
                              : "text-chiarli-text/60 group-hover:text-chiarli-text"
                          }`}
                        >
                          {note.title}
                        </span>
              ...
              <div className="relative mt-8 lg:mt-[175px]">
                <div
                  className="absolute top-1/2 left-1/2 w-48 md:w-64 h-48 md:h-64 rounded-full border border-chiarli-wine/10 hidden md:block"
                  style={{
                    transform: `translate(-50%, -50%) rotate(${scrollY * 0.02}deg)`,
                  }}
                />
                <div
                  className="absolute top-1/2 left-1/2 w-32 md:w-40 h-32 md:h-40 rounded-full border border-chiarli-text/5 hidden md:block"
                  style={{
            ...
            <div className="space-y-4 md:space-y-6">
              {[
                ...(wine.denomination
                  ...
                  : []),
                ...(wine.grape
                  ? [{ label: "Vitigno", value: wine.grape }]
                  : []),
                ...(wine.vinification
                  ? [{ label: "Vinificazione", value: wine.vinification }]
                  : []),
                ...(wine.alcohol
                  ? [
                      {
                ...
                ...(wine.servingTemp
                  ...
                  : []),
                ...(wine.format
                  ? [{ label: "Formato", value: wine.format }]
                  : []),
                ...(wine.year
                  ? [{ label: "Annata", value: wine.year.toString() }]
                  : []),
              ].map((item, index) => (
                <div
                  key={index}
              ...
              {wine.heritage ? (
                ...
                <>
                  <p className="font-serif text-base md:text-lg text-chiarli-text/70 leading-relaxed mb-4 md:mb-6">
                    Nel 1860, quando Cleto Chiarli iniziò la sua avventura nel
                    mondo del vino, il Lambrusco veniva prodotto esclusivamente
                  ...
                  <p className="font-serif text-base md:text-lg text-chiarli-text/70 leading-relaxed mb-6 md:mb-8">
                    Abbiamo riscoperto questa tecnica ancestrale per offrire un
                    Lambrusco che unisce la freschezza e l'eleganza del Sorbara
                    con le note di lievito tipiche della rifermentazione
                    tradizionale.
                  </p>
                </>
              )}
          ...
          <div className="max-w-[1200px] mx-auto px-4 md:px-6 lg:px-12 relative z-10 mb-8 md:mb-12">
            <div className="text-center">
              ...
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white">
                Premiato dalla{" "}
                <span className="italic text-chiarli-wine-light">critica</span>
              </h2>
            </div>
          </div>
