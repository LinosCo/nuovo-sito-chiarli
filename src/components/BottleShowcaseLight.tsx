...
const wines = [
  {
    ...
    family: "Premium",
    description:
      "Il nostro cru più prestigioso. Eleganza e complessità uniche.",
    image: "/foto/vini/001-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Premium", "DOC"],
  },
  {
    ...
    description:
      "Fragranza e florealità tipiche del Sorbara. Un classico intramontabile.",
    image: "/foto/vini/002-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Sorbara", "DOC"],
  },
  {
    ...
    family: "Metodo Classico",
    description:
      "Un Lambrusco moderno, secco e pulito. Perfetto con la gastronomia contemporanea.",
    image: "/foto/vini/003-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Dry", "Moderno"],
  },
  {
    ...
    family: "Metodo Classico",
    description:
      "Intenso e fruttato. Un Lambrusco che unisce corpo e freschezza.",
    image: "/foto/vini/005-uai-720x1080.webp",
    format: "0.75L",
  ...
  },
  {
    ...
    family: "Metodo Classico",
    description:
      "Amabile. Il vino della tradizione modenese, morbido e avvolgente.",
    image: "/foto/vini/006-uai-720x1080.webp",
    format: "0.75L",
  ...
  },
  {
    ...
    family: "Premium",
    description:
      "Eleganza e freschezza. Ottenuto da uve Grasparossa vinificate in rosa.",
    image: "/foto/vini/007-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Brut", "Rosé"],
  },
  {
    ...
    image: "/foto/vini/008-1-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Bio", "Organic"],
  },
  {
    ...
    family: "Premium",
    description:
      "La nostra cuvée speciale. Un blend che esprime il meglio delle nostre uve.",
    image:
      "/foto/vini/PHOTO-2025-10-22-14-49-54-senza-sfondo-uai-720x1080.webp",
    format: "0.75L",
    tags: ["Cuvée", "Premium"],
  },
];
...
export const BottleShowcaseLight: React.FC<BottleShowcaseLightProps> = ({
  onWineClick,
}) => {
