...
export const BottleShowcase: React.FC<BottleShowcaseProps> = ({
  onWineClick,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Filters - Animated */}
        <div
          className={`flex gap-4 md:gap-8 mb-16 border-b border-chiarli-text/10 pb-4 transition-all duration-700 delay-400 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 md:gap-y-16">
          {filteredWines.map((wine, index) => (
            <div
              key={wine.id}
              className={`group cursor-pointer transition-all duration-700 active:scale-[0.98] ${
                isVisible
                  ? "opacity-100 translate-y-0"
